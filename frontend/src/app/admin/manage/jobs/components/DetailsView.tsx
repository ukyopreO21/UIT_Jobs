...
const DetailsView = ({
    ...
    return (
        <Transition
            ...
            <div className="absolute z-20 flex flex-col bg-white border border-[#e7e7e8] bottom-4 top-16 right-4 w-140 h-fit max-h-[calc(100vh-5rem)] rounded-lg overflow-hidden shadow-md">

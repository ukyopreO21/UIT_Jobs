...
const FiltersView = ({
    ...
    const availableFilterValues = useAdminApplicationStore((state) => state.availableFilterValues);
    ...
    return (
        <Transition
            ...
            <div className="absolute z-20 flex flex-col bg-white border border-[#e7e7e8] top-16 right-4 w-120 rounded-lg overflow-hidden h-fit max-h-[calc(100vh-5rem)] shadow-xl">

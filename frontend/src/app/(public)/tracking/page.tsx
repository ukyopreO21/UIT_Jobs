...
const Tracking = () => {
    ...
    return (
        <div className="mt-12 max-w-7xl mx-auto flex-center flex-col gap-8 px-4">
                    ...
                    <div className="w-full bg-primary-bg rounded-md p-3">
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    Chúc mừng bạn đã vượt qua tất cả các vòng phỏng vấn và được
                                    tuyển dụng vào vị trí ứng tuyển.
                                </div>
                            </div>
                        </div>
                    </div>

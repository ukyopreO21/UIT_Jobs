...
const DetailView = ({
    ...
    useEffect(() => {
        setSelectedStatus({
            ...
            color: statusOptions.find((status) => status.label === application?.status)?.color,
        });
    }, [application]);
    ...
    return (
        <Transition
            ...
            <div className="absolute z-20 flex flex-col bg-white border border-[#e7e7e8] inset-y-4 right-4 w-160 rounded-lg overflow-hidden">
                <div className="flex justify-between p-4 border-b border-[#e7e7e8] shrink-0">
                    <div className="flex flex-col">
                        <span className="text-xl font-medium">#{application?.id}</span>
                        <span className="text-[#535458]">Mã hồ sơ</span>
                    </div>
                    <button className="cursor-pointer" onClick={toggleViewDetail}>
                        <AiOutlineClose
                            size={20}
                ...
                <div className="flex flex-col grow overflow-y-auto">
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        <span className="font-medium text-lg">CV</span>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Thời gian nộp</span>
                            <span className="flex-1">
                                {application ? formatDatetime(application.created_at) : ""}
                            </span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Vị trí ứng tuyển</span>
                            <span className="flex-1">{application?.position}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Đơn vị</span>
                            <span className="flex-1">{application?.department}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Link CV</span>
                            <span className="flex-1">{application?.applicant_cv}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Vị trí ứng tuyển</span>
                            <span className="flex-1">{application?.second_choice_position}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Đơn vị</span>
                            <span className="flex-1">{application?.second_choice_department}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            ...
                            <span className="flex-1">
                                {application ? formatDatetime(application.updated_at) : ""}
                            </span>
                        </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            ...
                            <span className="flex-1">{application?.applicant_name}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Giới tính</span>
                            <span className="flex-1">{application?.applicant_gender}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Ngày sinh</span>
                            <span className="flex-1">
                                {application ? formatDate(application.applicant_dob) : ""}
                            </span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">CCCD/CMND</span>
                            <span className="flex-1">{application?.applicant_id}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            ...
                            <span className="flex-1">{application?.applicant_email}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Số điện thoại</span>
                            <span className="flex-1">{application?.applicant_phone}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Địa chỉ thường trú</span>
                            <span className="flex-1">
                                {application?.applicant_permanent_address}
                            </span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Địa chỉ liên hệ</span>
                            <span className="flex-1">{application?.applicant_contact_address}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            ...
                            <span className="flex-1">{application?.applicant_degree}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Cơ sở đào tạo</span>
                            <span className="flex-1">{application?.applicant_inst_name}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Ngành, chuyên ngành</span>
                            <span className="flex-1">{application?.applicant_major}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Năm tốt nghiệp</span>
                            <span className="flex-1">{application?.applicant_grad_year}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Xếp loại</span>
                            <span className="flex-1">{application?.applicant_grad_grade}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col p-4 gap-3 border-b border-[#e7e7e8] shrink-0">
                        ...
                        <div className="flex">
                            ...
                            <span className="flex-1">{application?.applicant_lang_lvl}</span>
                        </div>
                        <div className="flex">
                            <span className="flex-1 text-[#535458]">Tin học</span>
                            <span className="flex-1">{application?.applicant_it_prof_lvl}</span>
                        </div>
                    </div>

                    <div className="flex flex-col p-4 gap-3 shrink-0">
                        <span className="font-medium text-lg">Ghi chú</span>
                        <span>{application?.applicant_note || "Không có"}</span>
                    </div>
                </div>
            </div>
        </Transition>
